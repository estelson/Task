...
import com.exemplo.task.databinding.BottomSheetBinding
...
fun Fragment.getFormatedString(@StringRes resId: Int, vararg formatArgs: Any?): CharSequence {
    return resources.getString(resId, *formatArgs)
}

fun Fragment.getFormatedString(@StringRes resId: Int): CharSequence {
